        ...
        <Container fluid className="mt-5 py-5">
            <Row className="container-contacto">
                <Col className="col-contacto">
                    ...
                    <h2 style={{ color: "red" }} className="pb-3">Terminos y Condiciones</h2>
                    <div className="col-contacto">
                        <p className="pt-5 m-1 text-align-center">
                            <h3 style={{
                                paddingTop:"15px"
                            }}><b>Al navegar y utilizar el sitio</b></h3>
                            <b> www.piancatelli-propiedades.com.ar</b> el usuario declara haber
                            leído y aceptado los términos y condiciones detallados aquí. Si
                            el usuario no está de acuerdo con los términos y condiciones,
                            debe salir inmediatamente del sitio. Piancatelli Propiedades se
                            reserva el derecho de cambiar los términos y condiciones de uso
                            de su sitio web en cualquier momento y sin previo aviso.
                            <h3 style={{
                                paddingTop:"15px"
                            }}><b>Uso del
                                contenido</b></h3>
                            ...
                            <b> www.piancatelli-propiedades.com.ar</b> exclusivamente para su uso
                            personal. Queda expresamente prohibida la reproducción total o
                            ...
                            <h3 style={{
                                paddingTop:"15px"
                            }}><b>Logos y Marcas</b></h3>

                            Todos los
                            logos y marcas de Piancatelli exhibidos en el sitio
                            ...
                            Piancatelli Propiedades. Cualquier otro logos y/o marca
                            utilizados en el sitio<b> www.piancatelli-propiedades.com.ar</b> son de
                            propiedad de sus respectivos dueños.

                            <h3 style={{
                                paddingTop:"15px"
                            }}><b>Veracidad del contenido</b></h3>
                            ...
                            Las opiniones expresadas en este sitio web
                            son exclusivas de sus autores específicos, y no representan
                            necesariamente la opinión, consejo o información de Piancatelli
                            Propiedades. Enlaces a otros sitios web De existir en el sitio
                            web<b> www.piancatelli-propiedades.com.ar</b> enlaces hacia otros
                            ...
                            ningún servicio o producto de terceros. Otras Empresas
                            ...
                            El uso del sitio
                            <b> www.piancatelli-propiedades.com.ar</b> y sus términos y condiciones
